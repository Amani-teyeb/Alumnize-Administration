...
export const mycourselistConstants = {
  GET_MYCOURSELIST_REQUEST: 'GET_MYCOURSELIST_REQUEST',
  GET_MYCOURSELIST_SUCCESS: 'GET_MYCOURSELIST_SUCCESS',
  GET_MYCOURSELIST_FAILURE: 'GET_MYCOURSELIST_FAILURE',
};
